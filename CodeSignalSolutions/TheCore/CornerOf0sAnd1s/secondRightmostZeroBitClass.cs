/*
    ...
    Description:
        ...
        3710 =
        1001012. The second rightmost zero bit is at position 3 (0-based) from the right
...
namespace CodeSignalSolutions.TheCore.CornerOf0sAnd1s
{
    class secondRightmostZeroBitClass
    {
        ...
        {
          return (int)Math.Pow(2, Convert.ToString(n, 2).Length - Convert.ToString(n, 2).LastIndexOf('0',Convert.ToString(n, 2)
        .LastIndexOf('0') - 1) - 1);
        }
    }
}
