/*
    ...
    Description:
        ...
        You quickly
        discover that this approach is quite convenient: sometimes all you have to do is
        substitute the function arguments by adding the $ sign in front of them. At
        first you do this manually, but soon realize that it won't get you far enough.
        ...
        Given a solution in JavaScript and its args,
        return the almost-PHP solution.
        ...
        is correct and can be executed in the CodeSignal
        environment with $ symbols removed;
        does not contain comments or string
        variables;
        does not start with one of the args.
        
        Due to system limitations,
        tabulation (\t) characters are used instead of newlines (\n).
        ...
        An array of
        distinct function arguments. It is guaranteed that each argument is valid, i.e.
        it consists only of uppercase and lowercase letters 'A' through 'Z', the
