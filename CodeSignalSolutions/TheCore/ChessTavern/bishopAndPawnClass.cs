/*
    ...
    Description:
        ...
        The
        bishop has no restrictions in distance for each move, but is limited to diagonal
        ...
        For
        bishop = "a1" and pawn = "c3", the output should be
        ...
        Coordinates of the black pawn in
        the same notation.
        ...
        true if the bishop can capture the
...
namespace CodeSignalSolutions.TheCore.ChessTavern
{
    class bishopAndPawnClass
    {
        ...
            return Math.Abs(PosX(bishop) - PosX(pawn)) == Math.Abs(PosY(bishop) - PosY(pawn));
        }
         
