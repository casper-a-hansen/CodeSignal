/*
    ...
    Description:
        ...
        The clicks the user has made. Note that a click does not necessarily result in a
        move:
        ...
        ['R', '.', '.', '.', '.', '.', '.', 'B', 'R'],
        ['.', '.', 'C', '.', '.', '.', '.', 'Y', 'O']]
        clicks = [[4, 8], [2, 1], [4, 4], [6, 4], [4, 8], [1, 2], [1, 4], [4, 8], [6,
        4]],
        ...
        (see above), or an empty cell ('.').
        It is guaranteed that initially there are no lines of five or more balls of the
        same color.
