/*
    ...
    Description:
        ...
        the greater overall weakness it has. For the given integer n, you need to answer
        two questions:
        ...
        an array of two elements, where the first element is the answer to the first
        ...
        divisors and the specific weakness of each number in range [1, 9]:
        ...
        As you can see, the maximal weakness is 2, and there
        are 2 numbers with that weakness level.
        ...
        Array of two elements: the weakness of the weakest number, and
        the number of integers in range [1, n] with this weakness.
