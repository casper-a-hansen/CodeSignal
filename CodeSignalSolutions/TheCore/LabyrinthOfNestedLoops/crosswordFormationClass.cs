/*
    ...
    Description:
        ...
        these
        four words should form four pairwise intersections;
        all words must be written
        either left-to-right or top-to-bottom;
        the area of the rectangle formed by empty
        cells inside the intersections isn't equal to zero.
        
        Given 4 words, find the
        number of ways to make a crossword following the above-described rules. Note
        that two crosswords which differ by rotation are considered different.
        ...
        The six crosswords can be formed as shown
        below:
        
          f                         f                             f
          o
        c r o s s w o r d     c r o s s w o r d
        c r o s s w o r d           r   o
        q     r
          m   q                     m   m                   u     m
          a   u
        ;  s q u a r e          ;        a     a
        ...
        The number of ways to make a correct crossword of the desired
        formation.
...
namespace CodeSignalSolutions.TheCore.LabyrinthOfNestedLoops
{
    class crosswordFormationClass
    {
        ...
                            .Where(t => t.wordIndex != word && t.wordIndex != second.wordIndex && t.wordIndex != 
        third.wordIndex))
                        {
        ...
         
        static IEnumerable<(int prevPosition, int wordIndex, int position)> Select(string word, Dictionary<char, (int 
        wordIndex, int position)[]> dic, int skip = 0)
        {
