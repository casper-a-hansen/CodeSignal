/*
    ...
    Description:
        ...
        *: multiplication; pop a, pop b, then push a * b
        ...
        the program starts executing at the top left corner, doing nothing according to
        the   command until it meets the v command, which makes the instructions direct
        it downward;
        ...
        the , operator produces the character with the ASCII value of 32, which is a
        ...
        the > command forces instructions to the right to execute; since there is a
        border to the right, the leftmost instruction in the fourth line is executed
        next;
