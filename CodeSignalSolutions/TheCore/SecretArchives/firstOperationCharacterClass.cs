/*
    ...
    Description:
        ...
        Note that several operations of the same type
        with equal priority are computed from left to right.
        
        See the explanation of the
        third example for more details about the operations priority in this problem.
        Example
        ...
        + and *. The result of + should be computed first, since it is enclosed in
        parentheses. Thus, the output is the index of the '+' sign, which is 3.
        
        For
        expr = "2 + 2 * 2", the output should be
        ...
        For expr = "((2 + 2) * 2) * 3 + (2 + (2 *
        2))", the output should be firstOperationCharacter(expr) = 28.
        
        There are two
        operations which are enclosed in two parentheses: + at the position 4, and * at
        the position 28. Since * has higher priority than +, the answer is 28.
        Input/Output
        ...
        A
        string consisting of digits, parentheses, addition and multiplication signs
