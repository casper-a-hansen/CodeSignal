/*
    ...
    Description:
        ...
        calculating the number of words in the text he has read, no longer than
        maxLength.
        ...
        For maxLength = 4 and
        text = "The
        Fox asked the stork, 'How is the soup?'",
        the output should be
        timedReading(maxLength, text) = 7.
        
        The boy has read the following words: "The",
        "Fox", "the", "How", "is", "the", "soup".
        ...
        A positive integer, the maximum
        length of the word the boy can read.
        ...
        A non-empty string of English letters and punctuation
        marks.
        ...
        The
        number of words the boy has read.
