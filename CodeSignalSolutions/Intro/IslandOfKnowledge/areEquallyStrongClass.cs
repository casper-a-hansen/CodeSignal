/*
    ...
    Description:
        ...
        For yourLeft = 10, yourRight = 15,
        friendsLeft = 15, and friendsRight = 10, the output should be
        areEquallyStrong(yourLeft, yourRight, friendsLeft, friendsRight) = true;
        For
        yourLeft = 15, yourRight = 10, friendsLeft = 15, and friendsRight = 10, the
        output should be
        ...
        areEquallyStrong(yourLeft, yourRight,
        ...
        A non-negative integer representing
        the heaviest weight you can lift with your right arm.
        ...
        representing the heaviest weight your friend can lift with his or her left arm.
        Guaranteed constraints:
        0 ≤ friendsLeft ≤ 20.
