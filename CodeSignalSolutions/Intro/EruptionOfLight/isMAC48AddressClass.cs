/*
    ...
    Description:
        ...
        The
        standard (IEEE 802) format for printing MAC-48 addresses in human-friendly form
        ...
        For inputString =
        "00-1B-63-84-45-E6", the output should be
        ...
        true if
        inputString corresponds to MAC-48 address naming rules, false otherwise.
...
namespace CodeSignalSolutions.Intro.EruptionOfLight
{
    class isMAC48AddressClass
    {
        ...
            var regex = new Regex("^([0-9A-F][0-9A-F]-){5}[0-9A-F][0-9A-F]$");
