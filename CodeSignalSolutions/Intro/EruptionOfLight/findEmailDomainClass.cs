/*
    ...
    Description:
        ...
        The domain
        name part of an email address may only consist of letters, digits, hyphens and
        dots. The local part, however, also allows a lot of different special
        ...
        For
        address = "prettyandsimple@example.com", the output should be
