/*
    ...
    Description:
        ...
        Given matrix, a rectangular matrix of
        integers, where each value represents the cost of the room, your task is to
        return the total sum of all rooms that are suitable for the CodeBots (ie: add up
        ...
        There are several haunted rooms, so we'll
        disregard them as well as any rooms beneath them. Thus, the answer is 1 + 5 + 1
        + 2 = 9.
        ...
        Note that the
        free room in the final column makes the full column unsuitable for bots (not
