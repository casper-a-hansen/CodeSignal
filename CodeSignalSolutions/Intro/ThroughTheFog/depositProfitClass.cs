/*
    ...
    Description:
        ...
        For deposit = 100, rate = 20,
        and threshold = 170, the output should be
        depositProfit(deposit, rate,
        threshold) = 3.
        ...
        Thus, it will take 3 years for your balance to pass the
        threshold, so the answer is 3.
        ...
        The initial deposit, guaranteed to be a positive
        integer.
        ...
        The
        rate of increase. Each year the balance increases by the rate percent of the
        current sum.
...
namespace CodeSignalSolutions.Intro.ThroughTheFog
{
    class depositProfitClass
    {
        ...
            {
                amount += amount * (double)rate / 100.0;
                years++;
            }
            return years;
        }
