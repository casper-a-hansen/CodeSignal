/*
    ...
    Description:
        ...
        integer desiredHeight, your task is to find how many days it'll take for the
        plant to reach this height.
        
        Example
        
        For upSpeed = 100, downSpeed = 10, and
        desiredHeight = 910, the output should be
        growingPlant(upSpeed, downSpeed,
        desiredHeight) = 10.
        ...
        The plant first reaches
        a height of 910 on day 10.
        ...
        A positive integer representing the daily growth of the
        plant.
        ...
        A
        positive integer representing the nightly decline of the plant.
        ...
        A positive
        integer representing the goal height.
